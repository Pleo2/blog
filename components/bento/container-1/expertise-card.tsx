    ...
    return (
        ...
        >
            <div className="flex flex-col justify-center items-center gap-2 hover:scale-105 transition-scale duration-400">
                ...
                <p className="gap-1 flex text-[10px] sm:text-xs items-center border border-white/20 p-1 sm:p-2 rounded-lg text-white/80 w-28 sm:w-32 md:w-36 justify-center whitespace-nowrap overflow-hidden text-ellipsis">
                    <span>
